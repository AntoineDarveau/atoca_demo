...
from jwst.extract_1d.soss_extract.atoca_utils import grid_from_map

def forward_model(input_flux, masked_pixels, wave_map, trace_profile, throughput,
                  kernel=None, wave_grid=None, n_os=2, spectral_order=1):
...
image, atoca_engine = forward_model(flux_fct, masked_pixels, wave_map, trace_profile, throughput,
                                    kernel=None, wave_grid=None, n_os=5, spectral_order=spectral_order)
